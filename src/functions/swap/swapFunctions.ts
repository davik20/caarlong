...
export const swapExactETHForTokens = async (tradeEntity, Percent) => {
...
export const swapExactTokensForETH = async (tradeEntity, Percent) => {
...
export const swapExactTokensForTokens = async (tradeEntity, Percent) => {
